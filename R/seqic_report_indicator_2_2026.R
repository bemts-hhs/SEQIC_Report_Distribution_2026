...
### SEQIC Indicator Calculations 2026 - Indicator 2 Missing Injury Time
...
# Regions
seqic_indicator_2_regions <- trauma_2021_2025 |>
...
# Level
seqic_indicator_2_level <- trauma_2021_2025 |>
  traumar::seqic_indicator_2(
    unique_incident_id = Unique_Incident_ID,
    level = Level,
    incident_time = Incident_Time,
...
# Agency-specific
seqic_indicator_2_results <- trauma_2021_2025 |>
  traumar::seqic_indicator_2(
    unique_incident_id = Unique_Incident_ID,
    level = Level,
    incident_time = Incident_Time,
...
# state level
seqic_indicator_2_results_state <- trauma_2021_2025 |>
  traumar::seqic_indicator_2(
    unique_incident_id = Unique_Incident_ID,
    level = Level,
    incident_time = Incident_Time,
...
seqic_indicator_2_results_state_age <- trauma_2021_2025 |>
  traumar::seqic_indicator_2(
    unique_incident_id = Unique_Incident_ID,
    level = Level,
    incident_time = Incident_Time,
...
# service areas
seqic_indicator_2_results_service_areas <- trauma_2021_2025 |>
  traumar::seqic_indicator_2(
    unique_incident_id = Unique_Incident_ID,
    level = Level,
    incident_time = Incident_Time,
...
seqic_indicator_2_results_verification <- trauma_2021_2025 |>
  traumar::seqic_indicator_2(
    unique_incident_id = Unique_Incident_ID,
    level = Level,
    incident_time = Incident_Time,

...
### SEQIC Indicator Calculations 2026 - Indicator 6 Head injury arrival time
...
# Regions
seqic_indicator_6_regions <- trauma_2021_2025 |>
...
# Level
seqic_indicator_6_level <- trauma_2021_2025 |>
  traumar::seqic_indicator_6(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    transfer_out_indicator = Acute_Transfer_Out,
...
# Agency-specific
seqic_indicator_6_results <- trauma_2021_2025 |>
  traumar::seqic_indicator_6(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    transfer_out_indicator = Acute_Transfer_Out,
...
# state level
seqic_indicator_6_results_state <- trauma_2021_2025 |>
  traumar::seqic_indicator_6(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    transfer_out_indicator = Acute_Transfer_Out,
...
seqic_indicator_6_results_state_age <- trauma_2021_2025 |>
  traumar::seqic_indicator_6(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    transfer_out_indicator = Acute_Transfer_Out,
...
# service areas
seqic_indicator_6_results_service_areas <- trauma_2021_2025 |>
  traumar::seqic_indicator_6(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    transfer_out_indicator = Acute_Transfer_Out,
...
seqic_indicator_6_results_verification <- trauma_2021_2025 |>
  traumar::seqic_indicator_6(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    transfer_out_indicator = Acute_Transfer_Out,

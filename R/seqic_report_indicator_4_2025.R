...
### SEQIC Indicator Calculations 2026 - Indicator 4 Autopsy
...
# Regions
seqic_indicator_4_regions <- trauma_2021_2025 |>
...
# Level
seqic_indicator_4_level <- trauma_2021_2025 |>
  traumar::seqic_indicator_4(
    level = Level,
    ed_disposition = ED_Acute_Care_Disposition,
    ed_LOS = Length_of_Stay,
...
# Agency-specific
seqic_indicator_4_results <- trauma_2021_2025 |>
  traumar::seqic_indicator_4(
    level = Level,
    ed_disposition = ED_Acute_Care_Disposition,
    ed_LOS = Length_of_Stay,
...
# state level
seqic_indicator_4_results_state <- trauma_2021_2025 |>
  traumar::seqic_indicator_4(
    level = Level,
    ed_disposition = ED_Acute_Care_Disposition,
    ed_LOS = Length_of_Stay,
...
seqic_indicator_4_results_state_age <- trauma_2021_2025 |>
  traumar::seqic_indicator_4(
    level = Level,
    ed_disposition = ED_Acute_Care_Disposition,
    ed_LOS = Length_of_Stay,
...
# service areas
seqic_indicator_4_results_service_areas <- trauma_2021_2025 |>
  traumar::seqic_indicator_4(
    level = Level,
    ed_disposition = ED_Acute_Care_Disposition,
    ed_LOS = Length_of_Stay,
...
seqic_indicator_4_results_verification <- trauma_2021_2025 |>
  traumar::seqic_indicator_4(
    level = Level,
    ed_disposition = ED_Acute_Care_Disposition,
    ed_LOS = Length_of_Stay,

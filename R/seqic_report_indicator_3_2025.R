...
### SEQIC Indicator Calculations 2026 - Indicator 3 Probability of Survival
### Calculated
...
# Regions
seqic_indicator_3_regions <- trauma_2021_2025 |>
...
# Level
seqic_indicator_3_level <- trauma_2021_2025 |>
  traumar::seqic_indicator_3(
    level = Level,
    trauma_type = Trauma_Type,
    unique_incident_id = Unique_Incident_ID,
...
# Agency-specific
seqic_indicator_3_results <- trauma_2021_2025 |>
  traumar::seqic_indicator_3(
    level = Level,
    trauma_type = Trauma_Type,
    unique_incident_id = Unique_Incident_ID,
...
# state level
seqic_indicator_3_results_state <- trauma_2021_2025 |>
  traumar::seqic_indicator_3(
    level = Level,
    trauma_type = Trauma_Type,
    unique_incident_id = Unique_Incident_ID,
...
seqic_indicator_3_results_state_age <- trauma_2021_2025 |>
  traumar::seqic_indicator_3(
    level = Level,
    trauma_type = Trauma_Type,
    unique_incident_id = Unique_Incident_ID,
...
# service areas
seqic_indicator_3_results_service_areas <- trauma_2021_2025 |>
  traumar::seqic_indicator_3(
    level = Level,
    trauma_type = Trauma_Type,
    unique_incident_id = Unique_Incident_ID,
...
seqic_indicator_3_results_verification <- trauma_2021_2025 |>
  traumar::seqic_indicator_3(
    level = Level,
    trauma_type = Trauma_Type,
    unique_incident_id = Unique_Incident_ID,

...
### SEQIC Indicator Calculations 2026 - Indicator 5 Substance Use
...
# Regions
seqic_indicator_5_regions <- trauma_2021_2025 |>
...
# Level
seqic_indicator_5_level <- trauma_2021_2025 |>
  traumar::seqic_indicator_5(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    blood_alcohol_content = Blood_Alcohol_Content,
...
# Agency-specific
seqic_indicator_5_results <- trauma_2021_2025 |>
  traumar::seqic_indicator_5(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    blood_alcohol_content = Blood_Alcohol_Content,
...
# state level
seqic_indicator_5_results_state <- trauma_2021_2025 |>
  traumar::seqic_indicator_5(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    blood_alcohol_content = Blood_Alcohol_Content,
...
seqic_indicator_5_results_state_age <- trauma_2021_2025 |>
  traumar::seqic_indicator_5(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    blood_alcohol_content = Blood_Alcohol_Content,
...
# service areas
seqic_indicator_5_results_service_areas <- trauma_2021_2025 |>
  traumar::seqic_indicator_5(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    blood_alcohol_content = Blood_Alcohol_Content,
...
seqic_indicator_5_results_verification <- trauma_2021_2025 |>
  traumar::seqic_indicator_5(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    blood_alcohol_content = Blood_Alcohol_Content,

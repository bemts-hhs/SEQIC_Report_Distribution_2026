...
### SEQIC Indicator Calculations 2026 - Indicator 1 Surgeon/Physician/Mid-Level
### response times
...
# Regions
seqic_indicator_1_regions <- trauma_2021_2025 |>
...
# Level
seqic_indicator_1_level <- trauma_2021_2025 |>
  traumar::seqic_indicator_1(
    trauma_team_activation_level = Trauma_Team_Activation_Level,
    trauma_team_physician_service_type = Trauma_Team_Physician_Service_Type,
    level = Level,
...
# Agency-specific
seqic_indicator_1_results <- trauma_2021_2025 |>
  traumar::seqic_indicator_1(
    trauma_team_activation_level = Trauma_Team_Activation_Level,
    trauma_team_physician_service_type = Trauma_Team_Physician_Service_Type,
    level = Level,
...
# state level
seqic_indicator_1_results_state <- trauma_2021_2025 |>
  traumar::seqic_indicator_1(
    trauma_team_activation_level = Trauma_Team_Activation_Level,
    trauma_team_physician_service_type = Trauma_Team_Physician_Service_Type,
    level = Level,
...
seqic_indicator_1_results_state_age <- trauma_2021_2025 |>
  traumar::seqic_indicator_1(
    trauma_team_activation_level = Trauma_Team_Activation_Level,
    trauma_team_physician_service_type = Trauma_Team_Physician_Service_Type,
    level = Level,
...
# service areas
seqic_indicator_1_results_service_areas <- trauma_2021_2025 |>
  traumar::seqic_indicator_1(
    trauma_team_activation_level = Trauma_Team_Activation_Level,
    trauma_team_physician_service_type = Trauma_Team_Physician_Service_Type,
    level = Level,
...
seqic_indicator_1_results_verification <- trauma_2021_2025 |>
  traumar::seqic_indicator_1(
    trauma_team_activation_level = Trauma_Team_Activation_Level,
    trauma_team_physician_service_type = Trauma_Team_Physician_Service_Type,
    level = Level,

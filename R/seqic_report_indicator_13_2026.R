...
### SEQIC Indicator Calculations 2026 - Indicator 13 Data Validity
...
# Regions
seqic_indicator_13_regions <- trauma_2021_2025 |>
...
# Level
seqic_indicator_13_level <- trauma_2021_2025 |>
  traumar::seqic_indicator_13(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    validity_score = Validity_Score,
...
# Agency-specific
seqic_indicator_13_results <- trauma_2021_2025 |>
  traumar::seqic_indicator_13(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    validity_score = Validity_Score,
...
# state level
seqic_indicator_13_results_state <- trauma_2021_2025 |>
  traumar::seqic_indicator_13(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    validity_score = Validity_Score,
...
seqic_indicator_13_results_state_age <- trauma_2021_2025 |>
  traumar::seqic_indicator_13(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    validity_score = Validity_Score,
...
# service areas
seqic_indicator_13_results_service_areas <- trauma_2021_2025 |>
  traumar::seqic_indicator_13(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    validity_score = Validity_Score,
...
seqic_indicator_13_results_verification <- trauma_2021_2025 |>
  traumar::seqic_indicator_13(
    level = Level,
    unique_incident_id = Unique_Incident_ID,
    validity_score = Validity_Score,
